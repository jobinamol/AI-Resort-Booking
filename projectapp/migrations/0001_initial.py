    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female')], max_length=10, verbose_name='Gender')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Admin Privileges')),
                ('is_active', models.BooleanField(default=True, verbose_name='Account Status')),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Account Creation Date')),
